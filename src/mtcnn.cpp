...
MTCNN::MTCNN(const string& proto_model_dir) {
    PNet_ = cv::dnn::readNetFromCaffe("mtcnn_model/det1-half.prototxt", "mtcnn_model/det1-half.caffemodel");
    RNet_ = cv::dnn::readNetFromCaffe("mtcnn_model/det2-half.prototxt", "mtcnn_model/det2-half.caffemodel");
    ONet_ = cv::dnn::readNetFromCaffe("mtcnn_model/det3-half.prototxt", "mtcnn_model/det3-half.caffemodel");
}
